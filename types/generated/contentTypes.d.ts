...
export interface ApiEtudiantEtudiant extends Schema.CollectionType {
...
export interface ApiFactureFacture extends Schema.CollectionType {
  ...
  attributes: {
    payementmethod: Attribute.String;
...
export interface ApiFormateurFormateur extends Schema.CollectionType {
  ...
  attributes: {
    Id_card: Attribute.UID;
    CV: Attribute.Media;
    VISAcard: Attribute.BigInteger;
    ...
    utilisateur: Attribute.Relation<
      ...
      'api::utilisateur.utilisateur'
    >;
    payes_formateur: Attribute.Relation<
      'api::formateur.formateur',
      'oneToOne',
      'api::payes-formateur.payes-formateur'
    >;
    Username: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiPayesFormateurPayesFormateur extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::payes-formateur.payes-formateur': ApiPayesFormateurPayesFormateur;
